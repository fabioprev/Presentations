...
\begin{frame}
	...
	[9] J. C. Nascimento \emph{et al.}, ``Trajectory classification using switched dynamical hidden
		Markov models'', Image Processing, 2010
	
	\vspace{-0.17cm}
	
	[11] D. L. Vail \emph{et al.}, ``Conditional random fields for activity recognition'', AAMAS, 2007
\end{frame}
...
\begin{frame}
	...
	[7] K. Kitani \emph{et al.}, ``Activity Forecasting'', ECCV, 2012
\end{frame}
