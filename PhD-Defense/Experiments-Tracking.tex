...
%	\vspace{-0.2cm}
	...
	\begin{center}
		\begin{tikzpicture}
			\node at (-2.25,0) [draw=black,ultra thick,inner sep=0pt]
			{
				\includegraphics[height=2.4cm]{Figures/Map-1}
			};
			\node at (2.25,0) [draw=black,ultra thick,inner sep=0pt]
			{
				\includegraphics[height=2.4cm]{Figures/Map-2}
			};
		\end{tikzpicture}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\begin{tikzpicture}
			\node at (-2.48,0) [draw=black,ultra thick,inner sep=0pt]
			{
				\includegraphics[height=2.6cm]{Figures/Map-1}
			};
			\node at (2.48,0) [draw=black,ultra thick,inner sep=0pt]
			{
				\includegraphics[height=2.6cm]{Figures/Map-2}
			};
		\end{tikzpicture}
	\end{center}
	...
	\begin{center}
		...
		\begin{tikzpicture}
			...
			\node at (0,0) [draw=black,ultra thick,inner sep=0pt]
			{
				\includegraphics[height=2.6cm]{Figures/RFID}
			};
		\end{tikzpicture}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\begin{tikzpicture}
			\node at (-2.2,0) [draw=black,ultra thick,inner sep=0pt]
			{
				\includegraphics[height=2.6cm]{Figures/PETS2009-7}
			};
			\node at (2.2,0) [draw=black,ultra thick,inner sep=0pt]
			{
				\includegraphics[height=2.6cm]{Figures/IssiaSoccer-Camera1}
			};
		\end{tikzpicture}
	\end{center}
	...
	\begin{center}
		...
		\begin{tikzpicture}
			...
			\node at (0,0) [draw=black,ultra thick,inner sep=0pt]
			{
				\includegraphics[height=2.6cm]{Figures/Boat-3}
			};
		\end{tikzpicture}
	\end{center}
...
%			\hline
%			occlusions-1.avi & NO & 0.815 & 0.613 \\
%			\hline
%			occlusions-1.avi & YES & 0.975 & 0.871 \\
%			\hline
%			occlusions-2.avi & NO & 0.910 & 0.554 \\
%			\hline
%			high-view.avi & NO & 0.910 & 0.604 \\
%			\hline
%		\hline
%		\end{tabular}
%	\end{table}
