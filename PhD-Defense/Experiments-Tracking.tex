...
\begin{frame}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\node at (3.95,0) [draw=black,ultra thick,inner sep=0pt]  {\includegraphics[height=3.1cm]{Figures/Boat-2}};
			\node at (7.95,0) [draw=black,ultra thick,inner sep=0pt]  {\includegraphics[height=3.1cm]{Figures/Boat-3}};
		\end{tikzpicture}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\node at (6,0) [draw=black,ultra thick,inner sep=0pt]  {\includegraphics[height=3.25cm]{Figures/Map-2_}};
		\end{tikzpicture}
	\end{center}
