...
\begin{frame}
	...
	\begin{center}
		\href{run:../Scripts/activity.sh}
		{
			\begin{tikzpicture}
				\node at (0,0) [draw=black,ultra thick,inner sep=0pt]
				{
					\includegraphics[width=0.7\linewidth]{Figures/InSpace_FrontCamera}
				};
			\end{tikzpicture}
		}
	\end{center}
	...
	\begin{center}
		\href{run:../Scripts/inspace.sh}
		{
			\begin{tikzpicture}
				\node at (0,0) [draw=black,ultra thick,inner sep=0pt]
				{
					\includegraphics[width=0.7\linewidth]{Figures/InSpace}
				};
			\end{tikzpicture}
		}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\href{run:../Scripts/interactive.sh}
		{
			\begin{tikzpicture}
				\node at (0,0) [draw=black,ultra thick,inner sep=0pt]
				{
					\includegraphics[width=0.7\linewidth]{Figures/InteractiveCostmap}
				};
			\end{tikzpicture}
		}
	\end{center}
