...
\begin{frame}
	...
	\begin{columns}[T]
		...
		\begin{itemize}
			\item Complex perception-action
		
			\item Cooperation and Coordination
		
			\item Planning and Game Strategy
		...
		\begin{tikzpicture}
			...
			{
				\includegraphics[width=5cm]{Figures/Challenge-1}
			};
			\node at (0,-3.4) [draw=black,ultra thick,inner sep=0pt]
			{
				\includegraphics[width=5cm]{Figures/Challenge-2}
			};
		\end{tikzpicture}
	\end{columns}
\end{frame}
